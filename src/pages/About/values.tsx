    ...
    return (
        <section className="bg-[#F6F9FB]">
            <div className="px-4 sm:px-6 lg:px-20 py-14 lg:py-20">
                ...
                {/* Heading */}
                <h2 className="mt-4 text-3xl lg:text-[40px] font-medium leading-tight lg:leading-[48px] tracking-[-1.8px] text-[#0B1F3B] max-w-[562px]">
                    Our guiding principles for
                    delivering world-class healthcare.
                </h2>

                {/* Grid */}
                <div className="mt-12 lg:mt-[60px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-10 lg:gap-y-[40px] lg:gap-x-[70px]">
                    {values.map((v, idx) => (
                        <article
                            key={v.title}
                            className="pb-[40px] border-b border-[#676767]"
                        >
