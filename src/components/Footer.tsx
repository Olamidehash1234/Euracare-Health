      ...
      <div className="px-[16px] lg:px-20 py-[60px] lg:py-[80px]">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center lg:flex-row lg:items-center lg:justify-between mb-[30px] lg:mb-[40px]">
          ...
          <img
            src="/logo-ft.svg"
            alt="Euracare Logo"
            className="h-[50px] w-[135px] lg:h-auto lg:w-auto mb-[10px] lg:mb-0"
          />

          {/* Contact Info */}
          <div>
            <p className="text-[#010101] lg:leading-[32px] tracking-[-0.6px] text-[16px] mb-1">
              Enquiries & Appointments:{" "}
              <span className="font-bold hover:underline underline-offset-[4px]">
                <a href="tel:+234 909 444 4413">+234 909 444 4413</a>
              </span>
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-[32px] mb-[30px] lg:mb-[40px]">
          <Link
            to="/enquiry"
            className="flex items-center justify-center gap-[8px] py-[12px] lg:py-[22px] lg:text-[16px] leading-[27px] lg:tracking-[-0.54px] border border-[#010101] rounded-full text-[#010101] hover:bg-gray-50 transition-colors"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-[20px] lg:gap-[50px] mb-[20px] lg:mb-[40px]">
          ...
          <div>
            ...
            >
              ...
              <span className="lg:hidden">
                {openSections.about ? (
                  <img src="/footer/dash.svg" alt="minus" />
                ) : (
            ...
            <ul
              className={`space-y-[10px] lg:space-y-[16px] mt-[20px] lg:mt-0 ${!openSections.about ? "hidden lg:block" : ""}`}
            >
              <li>
                <Link
                  to="/about"
                  className="text-[#010101] hover:text-[#0C2141] leading-[27px] text-[16px] lg:tracking-[-0.54px] transition-colors"
                >
                  Who we are
                </Link>
              </li>
          ...
          <div>
            ...
            <div
              className={`space-y-[16px] ${!openSections.services ? "hidden lg:block" : ""}`}
            >
          ...
          <div>
            ...
            <ul
              className={`space-y-[10px] lg:space-y-[16px] mt-[20px] lg:mt-0 ${!openSections.media ? "hidden lg:block" : ""}`}
            >
              <li>
                <Link
                  to="/home/news"
          ...
          <div>
            ...
            <div
              className={`${!openSections.contact ? "hidden lg:block" : ""}`}
            >
              <div className="mb-[10px] mt-[20px] lg:mt-0">
                <p className="text-[#010101] mb-[10px] lg:mb-[16px] text-[#010101] hover:text-[#0C2141] leading-[27px] text-[16px] lg:tracking-[-0.54px] transition-colors">
                  293 Younis Bashorun Street cnr Jide Oki Street, Victoria
                  Island Lagos, Nigeria
                </p>

                <div className="space-y-[10px] lg:space-y-[16px]">
                  <a
                    href="mailto:info@euracare.com.ng"
                    className="flex items-center text-[#010101] hover:text-[#0C2141] leading-[27px] text-[16px] lg:tracking-[-0.54px] transition-colors"
                  >
              ...
              <div className="flex space-x-[5px] items-center">
                <a
                  href="https://wa.link/jq5wd7"
                  className="border border-[#626F82] rounded-[16px] py-[5px] px-[14px] flex items-center"
                >
                  <img
                    src="/whatsapp.png"
                    alt=""
                ...
                <a
                  href="https://www.facebook.com/share/1Bj6wnXQZQ/?mibextid=wwXIfr"
                  className=""
                >
                  <img src="/footer/facebook.svg" alt="" />
                </a>
                <a
                  href="https://www.instagram.com/euracare_?igsh=b3dtZ2N1NmJtbmFz"
                  className=""
                >
                  <img src="/footer/instagram.svg" alt="" />
                </a>
                <a
                  href="https://www.linkedin.com/company/euracare"
                  className=""
                >
                  <img src="/footer/linkedln.svg" alt="" />
                </a>
                <a
                  href="https://youtube.com/@euracare?si=Lk_j_x2TUY34acJl"
                  className="items-center border border-[#626F82] py-[5px] px-[12px] rounded-[14px]"
                >
                  <img
        ...
        <div className="border-t border-[#626F82] pt-6 lg:pt-[20px]">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap items-center sm:justify-center space-x-6 lg:space-x-[24px] mb-4 lg:mb-0">
              <a
                href="#"
                className="text-[#010101] hover:text-[#0C2141] leading-[27px] text-[14px] lg:tracking-[-0.54px] transition-colors font-medium"
              >
                Cookie settings
              </a>
